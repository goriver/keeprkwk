...
class ScolarObj:
    def __init__(self, title, writer, date, depart, attach, attach_link):
        # 파이썬 생성자
...
class ScolarCrawling:
    ...
    for list in my_lists:
        ...
        em = ScolarObj(tmp_title, tmp_writer, tmp_date, tmp_depart, tmp_attach, tmp_attach_link)
        scolar_details.append(em)


    for detail in scolar_details:
        print("{}".format(detail.tmp_title))
