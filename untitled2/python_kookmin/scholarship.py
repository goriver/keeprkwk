...
#         pass
#
#     def posting_notices(self, school_scholar):
#         r = requests.post('https://kmuin.com/api/v1/notices/', data={"author": })
...
for detail in scholar_detail:
    r= requests.post('https://kmuin.com/api/v1/notices/', data = detail.article_text, "title" )
